...
<?php $component->withAttributes([]); ?>
	 <?php $__env->slot('title', null, []); ?> Daftar Aplikasi <?php $__env->endSlot(); ?>
...
<?php $component->withAttributes([]); ?>
		 <?php $__env->slot('option', null, []); ?> 
			<div class="btn btn-success add">
				<i class="fas fa-plus mr-1"></i> Tambahkan Aplikasi
			</div>
		 <?php $__env->endSlot(); ?>
...
<?php endif; ?>
	...
	<?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.modal','data' => ['title' => 'Tambahkan Aplikasi','id' => 'penyakit']]); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Tambahkan Aplikasi','id' => 'penyakit']); ?>
		<form action="<?php echo e(route('admin.penyakit.store')); ?>" method="POST">
			<?php echo csrf_field(); ?>
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label for="nama">Kode Aplikasi</label>
			...
			<div class="row mt-2">
				<div class="col-md-12">
					<div class="form-group">
						<label for="penyebab">Deskripsi Aplikasi</label>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\sitem pakar\resources\views/admin/penyakit/index.blade.php ENDPATH**/ ?>