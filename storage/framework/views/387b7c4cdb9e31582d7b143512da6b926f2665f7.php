...
<?php endif; ?>
            <div class="card">
                <div class="card-body">
                    ...
                    <p>Pilih Kriteria Yang Diinginkan</p>

                    <label for=""><b><i class="fas fa-th mr-1"></i> Kriteria</b></label>
                            ...
                            <div class="d-flex align-items-center justify-content-between border mb-2 p-2">
                                ...
                                <div>
                                    <select name="diagnosa[]" id="" class="form-control form-control-sm red-border">
                                        <option value="<?php echo e($value->id); ?>+-1" selected>Sangat Tidak Setuju</option>
                                        <option value="<?php echo e($value->id); ?>+-0.5">Tidak Setuju</option>
                                        <option value="<?php echo e($value->id); ?>+0">Netral</option>
                                        <option value="<?php echo e($value->id); ?>+0.5">Setuju</option>
                                        <option value="<?php echo e($value->id); ?>+1">Sangat Setuju</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\sitem pakar\resources\views/admin/diagnosa.blade.php ENDPATH**/ ?>