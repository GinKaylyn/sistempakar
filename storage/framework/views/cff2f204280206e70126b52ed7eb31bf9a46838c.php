...
<?php $component->withAttributes([]); ?>
	 <?php $__env->slot('title', null, []); ?> Hasil Sistem Pakar <?php $__env->endSlot(); ?>
...
<?php endif; ?>
	<?php endif; ?>
	<?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Berikut Hasil Perhitungan Sistem Pakar']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Berikut Hasil Perhitungan Sistem Pakar']); ?>
		<p class="mb-4">
		...
		<table class="table table-hover border">
			<thead class="thead-light">
				<tr>
					<th>Kriteria yang anda masukkan</th>
		...
		<div class="card card-body p-0 mt-5 border" style="box-shadow: none !important;">
			<div class="card-header bg-primary text-white p-2">
				<h6 class="font-weight-bold">Tabel perhitungan Sistem Pakar: <?php echo e($diagnosa['nama_penyakit']); ?> (<?php echo e($diagnosa['kode_penyakit']); ?>)</h6>
			</div>
		...
		<div class="mt-5">
			<div class="alert alert-success">
				...
				<p>Berdasarkan dari kriteria yang anda pilih dan juga berdasarkan Rule/Basis aturan yang telah kami teliti maka perhitungan Algoritma 
					Certainty Factor mengambil nilai CF yang paling pinggi yakni <b><?php echo e(number_format(unserialize($riwayat->cf_max)[0], 3)); ?> 
					(<?php echo e(number_format(unserialize($riwayat->cf_max)[0], 3) * 100); ?>%)</b> yaitu <b><?php echo e(unserialize($riwayat->cf_max)[1]); ?></b></p>
			</div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\sitem pakar\resources\views/admin/riwayat/show.blade.php ENDPATH**/ ?>