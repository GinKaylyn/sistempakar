                            ...
                            <div class="d-flex align-items-center justify-content-between border mb-2 p-2">
                                ...
                                <div>
                                    <select name="diagnosa[]" id="" class="form-control form-control-sm red-border">
                                        <option value="{{ $value->id }}+-1" selected>Sangat Tidak Setuju</option>
                                        <option value="{{ $value->id }}+-0.5">Tidak Setuju</option>
                                        <option value="{{ $value->id }}+0">Netral</option>
                                        <option value="{{ $value->id }}+0.5">Setuju</option>
                                        <option value="{{ $value->id }}+1">Sangat Setuju</option>
                                    </select>
                                </div>
                            </div>
                        </div>
